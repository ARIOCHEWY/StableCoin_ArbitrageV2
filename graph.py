...
from data import EXCHANGES, STABLE_COINS, COIN_MARKETS, normalize_price_to_usd
from fees import WITHDRAWAL_FEES, get_taker_fee
from transfer_time import get_chain_time_seconds
