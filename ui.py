...
from astar_volat import astar_best_path_with_liquidity, PlanResult, NodeId
...
def main():
    ...
    # Session state: store the current NetworkX graph
    ...
    with col_controls:
        ...
        best_trade_text = run_search_and_format(start_wallet, liquid_cash, heuristic)
        # Use textarea-style display so multi-line formatting looks nice
        st.text(best_trade_text)
